        ...
        <div className="flex items-center gap-12">
          ...
          <div className="text-center md:text-right space-y-2">
            ...
            <div className="flex gap-4 justify-center md:justify-end">
              <a href="https://github.com/ARZ023/DartStreamLine-professional-dart-file-merger" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-violet-600 dark:hover:text-white transition-colors">
